  ...
  return (
    <PageWrapper name='beliefs' className='flex flex-col gap-8'>
        ...
        <section className="beliefs-icc">
            ...
            <h1 className='text-3xl font-bold'>ICC Beliefs</h1>
        ...
        <section className="beliefs-God">
            ...
            <h2 className='text-2xl font-bold'>God</h2>
            ...
            <ul>
                <li>
                    ...
                    <p className='text-sm text-[var(--font-color-4)]'>(Deuteronomy 6:4; Revelation 1:8; Psalm 90:2; Matthew 28:19; 1 Peter 1:2)</p>
                </li>
                ...
                <li>
                    ...
                    <p className='text-sm text-[var(--font-color-4)]'>(Luke 1:35; John 1:1,14; Acts 1:9; Romans 1:3-4; 1 Corinthians 15:3-5; 2 Corinthians 5:21; Hebrews 4:15)</p>
                </li>
                ...
                <li>
                    ...
                    <p className='text-sm text-[var(--font-color-4)]'>(John 14:16-17; John 16:7-13; Acts 1:8; Acts 2:38, 1 Corinthians 2:12; 1 Corinthians 3:16; Ephesians 1:13; Galatians 5:25; Ephesians 5:18)</p>
                </li>
            </ul>
        ...
        <section className="beliefs-people">
            ...
            <ul>
                <li>
                    ...
                    <p className='text-sm text-[var(--font-color-4)]'>(Genesis 1:26-27; Genesis 5:1-2; John 4:24; Colossians 3:10; Ephesians 4:24)</p>
                </li>

                <li>
                    <p><span className='font-semibold'>#5</span> All people are sinners and need God's forgiveness.</p> 
                    
                    <p className='text-sm text-[var(--font-color-4)]'>(Romans 3:23; Romans 5:12-21; 1 Corinthians 15:21-22)</p>
                </li>
                ...
                <li>
                    ...
                    <p className='text-sm text-[var(--font-color-4)]'>(John 3:16-17; Romans 5:1; Romans 6:4; 2 Corinthians 5:20-21; Ephesians 2:8-9, Galatians 3:26)</p>
                </li>
            </ul>
        ...
        <section className="beliefs-faith">
            ...
            <h2 className='text-2xl font-bold'>The Church, the Bible, and Christ's Return</h2>
            
            <ul>
                <li>
                    <p><span className='font-semibold'>#7</span> Jesus Christ is head of the church and all believing people are members.</p>
                    
                    <p className='text-sm text-[var(--font-color-4)]'>(Matthew 16:13-20; Ephesians 4:15-16; Colossians 1:15-20; Revelation 1-3)</p>
                </li>
                ...
                <li>
                    ...
                    <p className='text-sm text-[var(--font-color-4)]'>(2 Timothy 3:16-17; 2 Peter 1:20-21)</p>
                </li>

                <li>
                    <p><span className='font-semibold'>#9</span> Jesus Christ will return and there will be a final judgment.</p>
                    
                    <p className='text-sm text-[var(--font-color-4)]'>(John 14:3; Philippians 3:20-21; 1 Thessalonians 4:13-18; Hebrews 9:27-28)</p>
                </li>
            </ul>
