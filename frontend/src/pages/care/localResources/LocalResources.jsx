...
const LocalResources = () => {
    return (
        <PageWrapper name='local-resources' className='flex flex-col gap-12 mx-auto' maxWidth=''>
            ...
            <section className="">
                <h2 className='text-xl sm:text-2xl md:text-3xl font-bold'>Resources for unemployment services, financial assistance, housing/rental assistance, food assistance, legal services, student services, and more...</h2>
            ...
            <section className="">
                <h2 className='text-xl sm:text-2xl font-bold'>Support Services</h2>
            ...
            <section className="">
                <h2 className='text-xl sm:text-2xl font-bold'>Senior Services</h2>
            ...
            <section className="">
                <h2 className='text-xl sm:text-2xl font-bold'>Veteran Services</h2>
            ...
            <section className="">
                <h2 className='text-xl sm:text-2xl font-bold'>Services for Disabled</h2>
            ...
            <section className="">
                <h2 className='text-xl sm:text-2xl font-bold'>Addiction Services</h2>
